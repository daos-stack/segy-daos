...
int main(int argc, char* argv[])
{
	...
	if(container_string[10] == 'f') {
		container_string[10] = 'a';
	} else if(container_string[10] == '9') {
		container_string[10] = '1';
	} else {
		container_string[10] = container_string[10] + 1;
	}

  const struct CMUnitTest tests[] = {
    cmocka_unit_test(create_graph_test),
    cmocka_unit_test(open_graph_test)
  };
