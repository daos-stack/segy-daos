...
main(int argc, char **argv)
{
    ...
    cwp_String *key2;	/* first input key(s)		*/
    key2 = (cwp_String*) malloc(SU_NKEYS * sizeof(cwp_String));
    cwp_String *key3;	/* second input key(s)		*/
    key3 = (cwp_String*) malloc(SU_NKEYS * sizeof(cwp_String));
    cwp_String *type1;	/* array of types for key1	*/
    type1 = (cwp_String*) malloc(SU_NKEYS * sizeof(cwp_String));
    cwp_String *type2;	/* array of types for key2	*/
    type2 = (cwp_String*) malloc(SU_NKEYS * sizeof(cwp_String));
    cwp_String *type3;	/* array of types for key3	*/
    type3 = (cwp_String*) malloc(SU_NKEYS * sizeof(cwp_String));
